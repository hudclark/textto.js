...
export default Ember.Component.extend({
    ...
    description: Ember.computed('stage', function () {
        ...
        switch (stage) {
            case 0:
                return 'Setting a master password will enable end-to-end encryption. For more information, visit <a target="_blank" href="https://sendleap.com/e2e">https://sendleap.com/e2e</a>.'
            case 1:
